...
class _ShopPageState extends State<ShopPage> {
  ...
  Widget build(BuildContext context) {
    return MyStatic.selectedCategorie.toString().isNotEmpty
        ? FutureBuilder(
            future: produitRepository.giveMeMethode(widget.id),
            builder: (context, snapshot) {
              print('length ${snapshot.hasData}');
              if (snapshot.hasData) {
                        ...
                        child: Row(
                          children: [
                            Container(
                                ...
                                child: Image.network(widget.imglogo.toString(),
                                    width: 55,
                                    height: 35,
                                    color: Colors.white)),
                            SizedBox(
                  ...
                  body: sns.isEmpty
                      ...
                      : GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Opacity(
                              opacity:
                                  sns[index].articles.length == 2 ? 0.7 : 1,
                              child: Container(
